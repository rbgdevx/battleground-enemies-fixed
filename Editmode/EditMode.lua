...
---@class BattleGroundEnemies
local BattleGroundEnemies = BattleGroundEnemies or _G.BattleGroundEnemies or Data.BattleGroundEnemies
...
function BattleGroundEnemies.EditMode.EditModeManager:AddFrame(frame, systemName, systemNameLocalized, playerButton)
  ...
  if not frame.Selection then
    ...
    frame.Selection.MouseOverHighlight:SetAllPoints()
    frame.Selection.MouseOverHighlight:SetAlpha(0.4)
    frame.Selection.MouseOverHighlight:Hide()
